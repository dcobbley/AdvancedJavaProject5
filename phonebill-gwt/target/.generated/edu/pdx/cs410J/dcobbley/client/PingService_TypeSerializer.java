...
public class PingService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["[Ledu.pdx.cs410J.AbstractPhoneCall;/3952395117"] = [
        @edu.pdx.cs410J.AbstractPhoneCall_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @edu.pdx.cs410J.AbstractPhoneCall_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Ledu/pdx/cs410J/AbstractPhoneCall;),
      ];
    
    result["edu.pdx.cs410J.dcobbley.client.PhoneBill/4181077968"] = [
        @edu.pdx.cs410J.dcobbley.client.PhoneBill_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @edu.pdx.cs410J.dcobbley.client.PhoneBill_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Ledu/pdx/cs410J/dcobbley/client/PhoneBill;),
      ];
    
    result["edu.pdx.cs410J.dcobbley.client.PhoneCall/3720061900"] = [
        @edu.pdx.cs410J.dcobbley.client.PhoneCall_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @edu.pdx.cs410J.dcobbley.client.PhoneCall_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Ledu/pdx/cs410J/dcobbley/client/PhoneCall;),
      ];
    
    result["[Ledu.pdx.cs410J.dcobbley.client.PhoneCall;/2721176304"] = [
        @edu.pdx.cs410J.dcobbley.client.PhoneCall_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @edu.pdx.cs410J.dcobbley.client.PhoneCall_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Ledu/pdx/cs410J/dcobbley/client/PhoneCall;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@edu.pdx.cs410J.AbstractPhoneCall[]::class)] = "[Ledu.pdx.cs410J.AbstractPhoneCall;/3952395117";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@edu.pdx.cs410J.dcobbley.client.PhoneBill::class)] = "edu.pdx.cs410J.dcobbley.client.PhoneBill/4181077968";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@edu.pdx.cs410J.dcobbley.client.PhoneCall::class)] = "edu.pdx.cs410J.dcobbley.client.PhoneCall/3720061900";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@edu.pdx.cs410J.dcobbley.client.PhoneCall[]::class)] = "[Ledu.pdx.cs410J.dcobbley.client.PhoneCall;/2721176304";
  ...
  public PingService_TypeSerializer() {
